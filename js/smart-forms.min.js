...
})(
	{
		1: [
			function (e, t, n) {
				...
				var r = e("./src/Form"),
					o = e("./src/helpers/on"),
					i = e("./src/helpers/addStyles"),
					a = "https://bootstrapstudio.io/smartform-handler",
					u = "https://bootstrapstudio.io/smartform-iframe?large=1",
					s = "showMessage",
					l = null,
				...
				function v() {
					y({ status: "success", message: "Your message has been delivered." }), l.reset();
				}
				function b(e) {
					var t = "Oops...",
					...
					e &&
						e.error &&
						(e.error.title && (t = e.error.title), e.error.message && (n = e.error.message)),
						y({ status: "error", title: t, message: n });
				}
				i(c, {
					position: "fixed",
					top: "50%",
					...
					o(c, "load", null, function () {
						...
						10485760 < l.getFileSize()
							? y({
									status: "error",
									message: "Please make sure the total size of attachments is less than 10mb.",
							  })
							: d({ operation: "showRecaptcha" }, "*");
					}),
						...
						function (e) {
							e.preventDefault(),
								(l = new r(e.target, {
									onSuccess: v,
									onError: b,
									beforeSend: y.bind(null, { status: "loading", message: "Sending..." }),
								})),
								(c.src = u),
			...
			{ "./src/Form": 6, "./src/helpers/addStyles": 10, "./src/helpers/on": 11 },
		],
		2: [
			function (e, t, n) {
				"use strict";
						...
						r(t, null, [
							...
							},
							{
								...
								value: function (n) {
									...
									for (var a in (n.beforeSend && n.beforeSend(),
									i.open(r, o, !0),
									(i.onload = function (e) {
										if (4 === i.readyState) {
											var t = {};
											try {
												(t = JSON.parse(i.responseText)),
													200 === i.status ? n.success && n.success(t) : n.error && n.error(t);
											} catch (e) {
												console.error(e);
											}
										}
					...
					return (
						o(r, [
							...
							},
							{
								key: "getParentByTag",
								value: function (e) {
									for (var t = this.element; (t = t.parentNode) && t !== document; ) {
								...
								},
								{
									...
									value: function () {
										for (var e = [], t = 0; t < this.element.files.length; t++)
											e.push({
												name:
													(this.isNameSet() ? this.getName() : this.identifier) +
						...
						return (
							...
							o(r, [
											...
											n.forEach(function (e) {
												if (e.hasValue())
													if (e.hasMultipleValues()) {
														var t = {
															name: e.getName(),
															data: { type: e.getType(), value: [].concat(e.getValue()) },
														};
														"checkbox" === e.getType() &&
															e.getSiblings().forEach(function (e) {
																t.data.value.push(e.getValue()), n.splice(n.indexOf(e), 1);
															}),
															(r = r.concat(t));
									...
									value: function (e, t) {
										var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : [],
											...
											i = [].filter
												...
												.map(function (e) {
													return { name: e.name.replace("data-bss-", ""), value: e.value };
												});
										r = r.concat(n, i);
								...
								},
								{
									key: "onSuccess",
									value: function (e) {
										this.options.onSuccess && this.options.onSuccess(e);
									},
								},
								{
									key: "onError",
						...
						return (
							...
							r(o, [
								...
								},
								{
									...
									value: function () {
										var e = void 0;
										if (this.id && (e = this.form.find("label[for=" + this.id + "]")))
											return new i(e);
								...
								},
								{
									...
									value: function () {
										...
										return this.element.name.trim()
											? this.form.getFieldsByType(this.constructor).filter(function (e) {
								...
								},
								{
									...
									value: function () {
										for (var e = [], t = 0; t < this.options.length; t++)
											this.options[t].selected && e.push({ value: this.options[t].textContent });
										return e;
									},
								},
							]),
		...
		11: [
			function (e, t, n) {
				"use strict";
				t.exports = function (e, t, u, s, n) {
					var r,
						l = void 0;
					(n = n || !1),
						(l = e ? ("string" == typeof e ? document.querySelector(e) : e) : document) &&
							((r = n
								? function (e) {
										for (
											var t = l.querySelectorAll(u), n = e.target, r = 0, o = t.length;
											r < o;
											r++
										)
											for (var i = n, a = t[r]; i && i !== l; ) {
												if (i === a) return s.call(a, e);
												i = i.parentNode;
											}
								  }
								: s),
